...
public class Main {
        ...
        Spark.get(
            ...
            Spark.post(
                ...
                ((request, response) -> {
                    ...
                    Session session = request.session();//adds user name to the session
                    session.attribute("userName", userName); //inform seesiion object as user has logged in.
    ...
    static void addTestMessages() {
        messages.add(new Message(0, -1, "Alice", "Hello world!"));//refer to if statement
        messages.add(new Message(1, -1, "Bob", "This is another thread!"));//refer to if statement
